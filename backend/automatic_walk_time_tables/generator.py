...
class AutomatedWalkTableGenerator:
    ...
    def __create_files(self):
        try:
            ...
            self.__logger.log(ExportStateLogger.REQUESTABLE, str(e), {'uuid': self.uuid, 'status': GeneratorStatus.ERROR})

        except Exception as e:
            self.__logger.error(e)
            self.__logger.log(ExportStateLogger.REQUESTABLE,
                        'Der Export ist leider fehlgeschlagen. Ein unbekannter Fehler ist aufgetreten!',
