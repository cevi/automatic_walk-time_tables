...
class Point:
    ...
    def to_json(self):
        ...
        return {"lat": lv95.lat, "lon": lv95.lon, "h": lv95.h, "type": lv95.type}
...
class Point_LV03(Point):
    ...
    def to_WGS84(self):
        ...
        return Point_WGS84(wgs84[0], wgs84[1], wgs84[2] if self.h != -1.0 else -1.0)
    ...
    def distance(self, pkt):
        ...
        return math.sqrt(
            math.pow(self.lat - pkt.lat, 2) + math.pow(self.lon - pkt.lon, 2)
        )
